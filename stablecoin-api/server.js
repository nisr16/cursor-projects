 ...
 *     description: Check if the API is running and healthy. This endpoint is used by monitoring systems and doesn't require authentication.
 *     tags: [Health]
 *     responses:
 *       200:
 ...
 * /api/info:
 *   get:
 *     summary: API information and capabilities
 *     description: Get comprehensive information about the API capabilities, available endpoints, and features. This helps banks understand what the API can do.
 *     tags: [Health]
 *     responses:
 *       200:
 ...
 *                 documentation:
 *                   type: string
 *                   description: Link to interactive documentation
 *                   example: "Visit /api-docs for interactive API documentation"
 *                 endpoints:
 *                   type: array
 *                   items:
 *                     type: string
 *                   description: List of available endpoints with descriptions
 *                   example: [
 ...
 *                   items:
 *                     type: string
 *                   description: List of system features and capabilities
 *                   example: [
 *                     "Multi-bank user management",
 *                     "Custom approval workflows",
 *                     "Role-based permissions",
