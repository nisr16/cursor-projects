...
const path = require('path'); // Web framework for creating the API server
...
// Landing page route
app.get('/', (req, res) => {
  res.sendFile(path.join(__dirname, 'dashboard-build', 'index-dashboard.html'));
});

// Dashboard route (fallback for React Router)
app.get('/dashboard', (req, res) => {

// Fallback route for production - simple HTML response
app.get('/', (req, res) => {
  res.send(`
<!DOCTYPE html>
<html>
<head>
    <title>Enterprise Stablecoin Platform</title>
    <style>
        body { font-family: Arial, sans-serif; margin: 40px; background: #0f172a; color: white; }
        .container { max-width: 800px; margin: 0 auto; }
        .card { background: #1e293b; padding: 30px; border-radius: 12px; margin: 20px 0; }
...
<body>
    <div class="container">
        <h1>🚀 Enterprise Stablecoin Platform</h1>
        <div class="card">
            <h2>📊 Operations Dashboard</h2>
            <p>Real-time mission control for executives, operations, and technical teams</p>
            <a href="/dashboard" class="btn">Launch Dashboard</a>
        </div>
        <div class="card">
            <h2>🔧 API Documentation</h2>
            <p>Interactive API documentation for banking operations</p>
            <a href="/api-docs" class="btn">View API Docs</a>
        </div>
        <div class="card">
            <h2>🏦 API Health</h2>
            <p>Check API status and endpoints</p>
...
const server = app.listen(port, () => {
  console.log(`🚀 Unified Enterprise Stablecoin Platform running at http://localhost:${port}`);
